...
void display_data(unsigned long int e_entry, unsigned char *e_ident);
void display_version(unsigned int e_type, unsigned char *e_ident);
void display_osabi(unsigned char *e_ident);

/**
 * check_elf - Checks if a file is an ELF file.
 * @e_ident: controling all the unseen process of the program.
 ...
 * @e_ident: controling all the unseen process of the program.
 * @e_type: controling all the unseen process of the program.
 */
void display_version(unsigned int e_type, unsigned char *e_ident)
{
	printf("  Version:                           %d",
...
int main(int _attribute((unused_)) argc, char *argv[])
{
	...
	display_data(header->e_ident, header->e_entry);
	display_version(header->e_ident, header->e_type);
